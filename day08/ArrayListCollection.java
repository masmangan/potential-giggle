...
public class ArrayListCollection {
    public static void main(String[] args) {
        ...
        ArrayListOfString items = new ArrayListOfString();
        ...
        display(items,
                "%nDisplay list contents with enhanced for each statement:");
    ...
    public static void display(ArrayListOfString items, String header) {
        System.out.printf(header); // display header

        // display each element in items
        // TODO: for (String item : items)
